...
// NewBasicBot initializes a new instance of BasicBot
func NewBasicBot(relayURL, nsec string, handler MessageHandler, plugins []BotPlugin) *BasicBot {
...
func (bot *BasicBot) connectAndListen(retrySignal chan error) {
	defer func() {
...
func (bot *BasicBot) subscribeAndProcessEvents(relay *nostr.Relay) {
...
func (bot *BasicBot) processEvents(sub *nostr.Subscription) {
...
func (bot *BasicBot) HandleEvent(event *nostr.Event) {
